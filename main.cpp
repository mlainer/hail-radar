...
int main() {
    ...
    // Dateinamen mit menschenlesbarem Zeitstempel erstellen
    const std::string csv_filename = "./data/" + timestamp + "_hail_speed.csv";
    const std::string range_csv_filename = "./data/" + timestamp + "_hail_range.csv";

    //auto now = std::chrono::system_clock::now();
    //auto duration = now.time_since_epoch();
    //auto seconds = std::chrono::duration_cast<std::chrono::seconds>(duration).count();
    //const std::string csv_filename = "./data/" + std::to_string(seconds) + "_hail_speed.csv";
    //const std::string range_csv_filename = "./data/" + std::to_string(seconds) + "_hail_range.csv";
